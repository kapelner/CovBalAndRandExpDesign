...
all_randomizations = uniqueperm2(rep(c(0, 1), n / 2))
#under matching restriction
restricted_randomizations = all_randomizations[
  all_randomizations[, 1] + all_randomizations[, 2] == 1 &
  all_randomizations[, 3] + all_randomizations[, 4] == 1 &
  all_randomizations[, 5] + all_randomizations[, 6] == 1,
]
...
res = data.frame(
  ...
  "var_tx_est" = c(
    var(res_iter[res_iter$procedure == "random", "tx_estimate"]),
    var(res_iter[res_iter$procedure == "restricted", "tx_estimate"])
  )
)
